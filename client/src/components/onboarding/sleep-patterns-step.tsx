...
export function SleepPatternsStep({ initialValue, onNext, onBack }: SleepPatternsStepProps) {
  ...
  const sleepPatterns = [
    'lessThan6', 'between6And7', 'between7And8', 'between8And9', 'moreThan9'
  ];
  
  return (
    <div className="flex-1 flex flex-col items-center justify-center">
      <h2 className="font-heading font-bold text-2xl mb-6 text-center">{t('sleepPatternsStep.title')}</h2>
      <p className="text-neutral-800 mb-6 max-w-xs text-center">{t('sleepPatternsStep.subtitle')}</p>
