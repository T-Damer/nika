...
export function ContraceptionStep({ initialValue, onNext, onBack }: ContraceptionStepProps) {
  ...
  const contraceptionMethods = [
    'none', 'pill', 'iud', 'condom', 'implant', 'injection', 'patch', 'ring', 'withdrawal', 'rhythm'
  ];
  
  return (
    <div className="flex-1 flex flex-col items-center justify-center">
      <h2 className="font-heading font-bold text-2xl mb-6 text-center">{t('contraceptionStep.title')}</h2>
      <p className="text-neutral-800 mb-6 max-w-xs text-center">{t('contraceptionStep.subtitle')}</p>
