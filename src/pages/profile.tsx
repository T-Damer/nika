                ...
                <div>
                  ...
                  >
                    <SelectTrigger id="cycleLength">
                      <SelectValue
                        placeholder={t('profile.selectCycleLength')}
                      />
                    </SelectTrigger>
                    <SelectContent>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center">
                  <span className="text-xs text-neutral-500 dark:text-neutral-500 mr-2">
          ...
          <CardContent className="pt-6">
            <Dialog>
              <DialogTrigger asChild>
                <Button
                  variant="outline"
                  className="w-full justify-start border-red-200 text-red-500 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-950"
                >
